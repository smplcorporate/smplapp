...
//
//     final fastTagmodel = fastTagmodelFromJson(jsonString);

import 'dart:convert';

FastTagmodel fastTagmodelFromJson(String str) => FastTagmodel.fromJson(json.decode(str));

String fastTagmodelToJson(FastTagmodel data) => json.encode(data.toJson());
...
class FastTagmodel {
    ...
    factory FastTagmodel.fromJson(Map<String, dynamic> json) => FastTagmodel(
        status: json["status"],
