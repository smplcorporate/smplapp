...
//
//     final userProfileDetailsRes = userProfileDetailsResFromJson(jsonString);

import 'dart:convert';

UserProfileDetailsRes userProfileDetailsResFromJson(String str) => UserProfileDetailsRes.fromJson(json.decode(str));

String userProfileDetailsResToJson(UserProfileDetailsRes data) => json.encode(data.toJson());

class UserProfileDetailsRes {
    bool status;
    String statusDesc;
    bool editAllow;
    ...
    factory UserProfileDetailsRes.fromJson(Map<String, dynamic> json) => UserProfileDetailsRes(
        status: json["status"],
