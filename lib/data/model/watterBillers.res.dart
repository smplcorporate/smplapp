...
//
//     final watterBilersModel = watterBilersModelFromJson(jsonString);

import 'dart:convert';

WatterBilersModel watterBilersModelFromJson(String str) => WatterBilersModel.fromJson(json.decode(str));

String watterBilersModelToJson(WatterBilersModel data) => json.encode(data.toJson());

class WatterBilersModel {
    bool status;
    String statusDesc;
    ...
    factory WatterBilersModel.fromJson(Map<String, dynamic> json) => WatterBilersModel(
        status: json["status"],
