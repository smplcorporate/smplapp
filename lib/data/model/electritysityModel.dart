...
class ElectricityModel {
  ...
  factory ElectricityModel.fromJson(Map<String, dynamic> json) =>
      ElectricityModel(
        ...
        circleList: List<CircleList>.from(
          json["circle_list"].map((x) => CircleList.fromJson(x)),
        ),
        defaultBillerCode: json["default_biller_code"],
        oldBills: List<OldBill>.from(
          json["old_bills"].map((x) => OldBill.fromJson(x)),
        ),
      );
...
class UserBalance {
  ...
  factory UserBalance.fromJson(Map<String, dynamic> json) =>
      UserBalance(balanceMain: json["balance_main"]?.toDouble());
...
// To parse this JSON data, do
//
//     final electricityBody = electricityBodyFromJson(jsonString);
