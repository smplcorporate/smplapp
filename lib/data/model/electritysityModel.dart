...
ElectricityModel electricityModelFromJson(String str) =>
    ElectricityModel.fromJson(json.decode(str));

String electricityModelToJson(ElectricityModel data) =>
...
class ElectricityModel {
  ...
  factory ElectricityModel.fromJson(Map<String, dynamic> json) =>
      ElectricityModel(
        ...
        billersList: List<BillersList>.from(
          json["billers_list"].map((x) => BillersList.fromJson(x)),
        ),
        isCircle: json["is_circle"],
        circleList:
            json["circle_list"] != null
                ? List<CircleList>.from(
                  json["circle_list"].map((x) => CircleList.fromJson(x)),
                )
                : null,
        defaultBillerCode: json["default_biller_code"],
        oldBills:
            (json["old_bills"] ?? json["old_recharges"]) != null
                ? List<OldBill>.from(
                  (json["old_bills"] ?? json["old_recharges"]).map(
                    (x) => OldBill.fromJson(x),
                  ),
                )
                : [],
      );
...
class BillersList {
  ...
  BillersList({required this.billerName, required this.billerCode});
...
class CircleList {
  ...
  CircleList({required this.circleName, required this.circleId});

  factory CircleList.fromJson(Map<String, dynamic> json) =>
      CircleList(circleName: json["circle_name"], circleId: json["circle_id"]);
...
class UserBalance {
  ...
  UserBalance({required this.balanceMain});

  factory UserBalance.fromJson(Map<String, dynamic> json) =>
      UserBalance(balanceMain: json["balance_main"]);

  Map<String, dynamic> toJson() => {"balance_main": balanceMain};
}

ElectricityBody electricityBodyFromJson(String str) =>
    ElectricityBody.fromJson(json.decode(str));

String electricityBodyToJson(ElectricityBody data) =>
    json.encode(data.toJson());
...
class ElectricityBody {
  ...
  factory ElectricityBody.fromJson(Map<String, dynamic> json) =>
      ElectricityBody(
