...
//
//     final loanRepaymentResponse = loanRepaymentResponseFromJson(jsonString);

import 'dart:convert';

LoanRepaymentResponse loanRepaymentResponseFromJson(String str) => LoanRepaymentResponse.fromJson(json.decode(str));

String loanRepaymentResponseToJson(LoanRepaymentResponse data) => json.encode(data.toJson());
...
class LoanRepaymentResponse {
    ...
    factory LoanRepaymentResponse.fromJson(Map<String, dynamic> json) => LoanRepaymentResponse(
        status: json["status"],
