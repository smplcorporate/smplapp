...
class RechargeOrBill extends StatelessWidget {
  final List<SectionModel> sections = [
    ...
    SectionModel(
      ...
      items: [
        IconLabel("Electricity Bill", "assets/elect.png"),
        ...
        IconLabel("Piped Gas", "assets/pepaidgas.png"),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromARGB(124, 62, 131, 106),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: const Color.fromARGB(255, 68, 128, 106)),
                        ),
                        child: Image.asset(
                          item.icon,
                          width: 40,
