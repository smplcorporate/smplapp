...
abstract class APIStateNetwork {
  ...
  @POST("onetime/b2c_common/state_list")
  Future<StateListCommon> getStateList();
  @POST("onetime/b2c_common/district_list")
  Future<DistirctCommonModel> getDistrictList(@Body() DistrcBodyRequest body);
  @POST("onetime/b2c_common/tehsil_list")
  Future<ThehSillCommonList> getTehsilList(@Body() ThehSillCommonBody body);
  @POST("others/b2c_dashboard/ticket_reply")
  Future<HttpResponse<dynamic>> replyToTicket(@Body() TicketReplyRequest body);
}
