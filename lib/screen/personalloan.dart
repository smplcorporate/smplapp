...
class PersonalLoanApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PersonalLoanApplyPage(),
    );
  }
}

class PersonalLoanApplyPage extends StatefulWidget {
  @override
  _PersonalLoanApplyPageState createState() => _PersonalLoanApplyPageState();
}

class _PersonalLoanApplyPageState extends State<PersonalLoanApplyPage> {
