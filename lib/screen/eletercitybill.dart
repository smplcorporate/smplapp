...
class Eletercitybill extends ConsumerStatefulWidget {
  final String circleCode;
  final String billerName;
  final String billerCode;
  const Eletercitybill({
    super.key,
  ...
  @override
  ConsumerState<Eletercitybill> createState() => _LoanAccountScreenState();
}

class _LoanAccountScreenState extends ConsumerState<Eletercitybill> {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            snap.fetchOption == false ? "Pay Now" : "Fetch Now",
                            style: GoogleFonts.inter(
                              fontSize: 20,
                              color: Colors.white,
                            ),
