...
class HomeLoanPage2 extends StatefulWidget {
  const HomeLoanPage2({super.key});

  @override
  State<HomeLoanPage2> createState() => _HomeLoanPage2State();
}

class _HomeLoanPage2State extends State<HomeLoanPage2> {
