...
import 'package:home/data/controller/broadBand.provider.dart';
...
import 'package:home/screen/summerysPages/broadbandForm.page.dart';
...
class BoardBansPage extends ConsumerStatefulWidget {
  const BoardBansPage({super.key});

  @override
  ConsumerState<BoardBansPage> createState() => _BoardBansPageState();
}

class _BoardBansPageState extends ConsumerState<BoardBansPage> {
