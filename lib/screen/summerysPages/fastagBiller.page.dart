...
class FastTagBillerPage extends ConsumerStatefulWidget {
  const FastTagBillerPage({Key? key}) : super(key: key);

  @override
  _FastTagBillerPageState createState() => _FastTagBillerPageState();
}

class _FastTagBillerPageState extends ConsumerState<FastTagBillerPage> {
