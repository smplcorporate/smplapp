...
class InsurancesummeryPage extends ConsumerStatefulWidget {
  final FetchBodymodel body;
  InsurancesummeryPage({required this.body});

  @override
  ConsumerState<InsurancesummeryPage> createState() => _InsurancesummeryPageState();
}

class _InsurancesummeryPageState extends ConsumerState<InsurancesummeryPage> {
