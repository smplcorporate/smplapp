...
class PipeGasSumery extends ConsumerStatefulWidget {
  final FetchBodymodel body;
  PipeGasSumery({required this.body});

  @override
  ConsumerState<PipeGasSumery> createState() => _PipeGasSumeryState();
}

class _PipeGasSumeryState extends ConsumerState<PipeGasSumery> {
