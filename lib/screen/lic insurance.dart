...
import 'package:home/screen/summerysPages/insuranceForm.page.dart'; // Make sure this file exists and accepts the accountNumber parameter





class InusrencePage extends ConsumerStatefulWidget {
  const InusrencePage({super.key});

  @override
  ConsumerState<InusrencePage> createState() => _InusrencePageState();
}

class _InusrencePageState extends ConsumerState<InusrencePage> {
