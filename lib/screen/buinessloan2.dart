...
class BusinessLoanPage2 extends StatefulWidget {
  const BusinessLoanPage2({super.key});

  @override
  State<BusinessLoanPage2> createState() => _BusinessLoanPage2State();
}

class _BusinessLoanPage2State extends State<BusinessLoanPage2> {
