...
// updated if you renamed the second page

class CreditBuilderApp extends StatelessWidget {
  const CreditBuilderApp({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: CreditBuilderApplyPage(),
    );
  }
}

class CreditBuilderApplyPage extends StatefulWidget {
  @override
  _CreditBuilderApplyPageState createState() => _CreditBuilderApplyPageState();
}

class _CreditBuilderApplyPageState extends State<CreditBuilderApplyPage> {
              ...
              child: Padding(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        'Credit Builder Membership Plan',
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            Future.delayed(const Duration(milliseconds: 300), () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const CreditBuilderPage2()), // or your renamed class
                              );
                            });
                          }
                        },
...
class CreditBuilderPage2 extends StatefulWidget {
  const CreditBuilderPage2({super.key});

  @override
  State<CreditBuilderPage2> createState() => _CreditBuilderPage2State();
}

class _CreditBuilderPage2State extends State<CreditBuilderPage2> {
  final _formKey = GlobalKey<FormState>();
