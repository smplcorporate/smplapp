...
class MiniKYCPage extends StatefulWidget {
  const MiniKYCPage({super.key});

  @override
  State<MiniKYCPage> createState() => _MiniKYCPageState();
}

class _MiniKYCPageState extends State<MiniKYCPage> {
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          inputFormatters: isAadhaar ? [FilteringTextInputFormatter.digitsOnly] : null,
          decoration: InputDecoration(
            counterText: isAadhaar ? '' : null,
            hintText: hint,
            hintStyle: hintStyle,
