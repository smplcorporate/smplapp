...
class PersonalLoanPage2 extends StatefulWidget {
  const PersonalLoanPage2({super.key});

  @override
  State<PersonalLoanPage2> createState() => _PersonalLoanPage2State();
}

class _PersonalLoanPage2State extends State<PersonalLoanPage2> {
