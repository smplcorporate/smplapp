...
class HomeLoanApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HomeLoanApplyPage(),
    );
  }
}

class HomeLoanApplyPage extends StatefulWidget {
  @override
  _HomeLoanApplyPageState createState() => _HomeLoanApplyPageState();
}

class _HomeLoanApplyPageState extends State<HomeLoanApplyPage> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            Future.delayed(const Duration(milliseconds: 300), () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const HomeLoanPage2()), // Update to HomeLoanPage2() if renamed
                              );
                            });
                          }
                        },
