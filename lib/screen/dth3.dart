...
class DthPrepaid3Page extends ConsumerStatefulWidget {
  final FetchBodymodel body;

  DthPrepaid3Page({Key? key, required this.body}) : super(key: key);

  @override
  ConsumerState<DthPrepaid3Page> createState() => _DthPrepaid3PageState();
}

class _DthPrepaid3PageState extends ConsumerState<DthPrepaid3Page> {
